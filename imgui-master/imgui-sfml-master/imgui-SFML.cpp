...
void DrawLine(const sf::Vector2f& a, const sf::Vector2f& b, const sf::Color& m_backgroundColorBuffer,
    float thickness)
{
    ImDrawList* draw_list = ImGui::GetWindowDrawList();
    sf::Vector2f pos = ImGui::GetCursorScreenPos();
    draw_list->AddLine(a + pos, b + pos, ColorConvertFloat4ToU32(m_backgroundColorBuffer), thickness);
}

void DrawRect(const sf::FloatRect& rect, const sf::Color& m_backgroundColorBuffer,
    float rounding, int rounding_corners, float thickness)
{
    ...
    draw_list->AddRect(
        ...
        ColorConvertFloat4ToU32(m_backgroundColorBuffer), rounding, rounding_corners, thickness);
}

void DrawRectFilled(const sf::FloatRect& rect, const sf::Color& m_backgroundColorBuffer,
    float rounding, int rounding_corners)
{
    ...
    draw_list->AddRectFilled(
        getTopLeftAbsolute(rect),
        getDownRightAbsolute(rect),
        ColorConvertFloat4ToU32(m_backgroundColorBuffer), rounding, rounding_corners);
}
