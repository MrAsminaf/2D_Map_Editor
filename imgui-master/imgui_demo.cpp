...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        {
            static ImVec4 m_backgroundColorBuffer = ImColor(114, 144, 154, 200);
            ...
            ImGui::SameLine(); ShowHelpMarker("Click on the colored square to open a color picker.\nCTRL+click on individual component to input value.\n");
            ImGui::ColorEdit3("MyColor##1", (float*)&m_backgroundColorBuffer, misc_flags);

            ImGui::Text("Color widget HSV with Alpha:");
            ImGui::ColorEdit4("MyColor##2", (float*)&m_backgroundColorBuffer, ImGuiColorEditFlags_HSV | misc_flags);

            ImGui::Text("Color widget with Float Display:");
            ImGui::ColorEdit4("MyColor##2f", (float*)&m_backgroundColorBuffer, ImGuiColorEditFlags_Float | misc_flags);

            ImGui::Text("Color button with Picker:");
            ImGui::SameLine(); ShowHelpMarker("With the ImGuiColorEditFlags_NoInputs flag you can hide all the slider/text inputs.\nWith the ImGuiColorEditFlags_NoLabel flag you can pass a non-empty label which will only be used for the tooltip and picker popup.");
            ImGui::ColorEdit4("MyColor##3", (float*)&m_backgroundColorBuffer, ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoLabel | misc_flags);
            ...
            bool open_popup = ImGui::ColorButton("MyColor##3b", m_backgroundColorBuffer, misc_flags);
            ImGui::SameLine();
            open_popup |= ImGui::Button("Palette");
            if (open_popup)
            {
                ImGui::OpenPopup("mypicker");
                backup_color = m_backgroundColorBuffer;
            }
            if (ImGui::BeginPopup("mypicker"))
            {
                ...
                ImGui::Separator();
                ImGui::ColorPicker4("##picker", (float*)&m_backgroundColorBuffer, misc_flags | ImGuiColorEditFlags_NoSidePreview | ImGuiColorEditFlags_NoSmallPreview);
                ImGui::SameLine();
                ImGui::BeginGroup();
                ImGui::Text("Current");
                ImGui::ColorButton("##current", m_backgroundColorBuffer, ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(60,40));
                ImGui::Text("Previous");
                if (ImGui::ColorButton("##previous", backup_color, ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_AlphaPreviewHalf, ImVec2(60,40)))
                    m_backgroundColorBuffer = backup_color;
                ImGui::Separator();
                ImGui::Text("Palette");
                for (int n = 0; n < IM_ARRAYSIZE(saved_palette); n++)
                {
                    ...
                    if (ImGui::ColorButton("##palette", saved_palette[n], ImGuiColorEditFlags_NoAlpha | ImGuiColorEditFlags_NoPicker | ImGuiColorEditFlags_NoTooltip, ImVec2(20,20)))
                        m_backgroundColorBuffer = ImVec4(saved_palette[n].x, saved_palette[n].y, saved_palette[n].z, m_backgroundColorBuffer.w); // Preserve alpha!
            ...
            ImGui::ColorButton("MyColor##3c", *(ImVec4*)&m_backgroundColorBuffer, misc_flags, ImVec2(80,80));
            ...
            ImGui::ColorPicker4("MyColor##4", (float*)&m_backgroundColorBuffer, flags, ref_color ? &ref_color_v.x : NULL);
    ...
    if (ImGui::CollapsingHeader("Popups & Modal windows"))
    {
        ...
        if (ImGui::TreeNode("Modals"))
        {
            ...
            if (ImGui::BeginPopupModal("Stacked 1"))
            {
                ...
                static float m_backgroundColorBuffer[4] = { 0.4f,0.7f,0.0f,0.5f };
                ImGui::ColorEdit4("color", m_backgroundColorBuffer);  // This is to test behavior of stacked regular popups over a modal
