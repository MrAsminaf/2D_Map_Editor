...
// Draw_list overloads. All positions are in relative coordinates (relative to top-left of the current window)
    ...
    void DrawRect(const sf::FloatRect& rect, const sf::Color& m_backgroundColorBuffer, float rounding = 0.0f, int rounding_corners = 0x0F, float thickness = 1.0f);
    void DrawRectFilled(const sf::FloatRect& rect, const sf::Color& m_backgroundColorBuffer, float rounding = 0.0f, int rounding_corners = 0x0F);
}
